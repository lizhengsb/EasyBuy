...
<body>
<form name="form" action="McommentServlet?action=index-fenye" method="post">
		<table align="right">
			<tr>
				<td>总共${Guestindex.totalPage}页</td>
				<td></td>
				...
				<td>当前第<select name="nowPage" id="sel"
					onchange="gopage(this.value)">
						<c:forEach begin="1" end="${Guestindex.totalPage}" var="p">
	...
	<script>
		var p=document.getElementById("sel").value = ${Guestindex.nowPage};
		if(p=="1"){
