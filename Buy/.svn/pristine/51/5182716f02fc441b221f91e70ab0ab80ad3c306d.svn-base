...
<body>
	<div id="header" class="wrap">
		...
		<div class="help">
			<a href="#" class="shopping">购物车</a><a href="login.jsp">登录</a><a
				href="zhuce.jsp">注册</a><a href="guestbook.html">留言</a>
		</div>
		<div class="navbar">
			<ul class="clearfix">
	...
	<div id="register" class="wrap">
		<div class="shadow">
			...
			<div class="box">
				...
				<form id="regForm" method="post" action="UserServlet?action=zhuce" onsubmit="return checkForm(this)">
					<table>
						<tr>
						...
						<tr>
							...
							<td><input class="text verycode" type="text" name="veryCode"
								...
								id="veryCode" src="ChecknodeServlet" /><a
								href="javascript:changeImage()">看不清，换一张</a><span></span></td>
						</tr>
						<tr>
							<td></td>
	...
	<script type="text/javascript">
		function changeImage() {
			var imgobj = document.getElementById("veryCode");
			imgobj.src = "ChecknodeServlet?ran=" + Math.random();
		}
	</script>
</body>
</html>