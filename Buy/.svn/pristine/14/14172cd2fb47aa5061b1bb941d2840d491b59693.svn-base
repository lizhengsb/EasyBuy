...
<body>
				...
				<form action="UploadServlet?action=add" method="post" enctype="multipart/form-data">
					<table class="form">
						...
						<tr>
							...
							<td><input type="text" class="text" name="productMiaoshu" /></td>
						</tr>
						<tr>
							<td class="field">库存</td>
							<td><input type="text" class="text tiny" name="productNuml" /></td>
						</tr>
						<tr>
							<td></td>
	...
	<div id="footer">Copyright &copy; 2015 天智立软件教育 All Rights Reserved. 京ICP证1000001号</div>
