...
<div class="main">
		<h2>回复留言</h2>
		<div class="manage">
			<form action="McommentServlet?action=reply" method="post">
				<table class="form">
					<tr>
						<td class="field">留言ID：</td>
						<td><input type="text" class="text" name="orderId" value="${guest.id }" readonly="readonly" /></td>
					</tr>
					<tr>
						<td class="field">留言姓名：</td>
						<td><input type="text" class="text" name="name" value="${guest.name }" /></td>
					</tr>
					<tr>
